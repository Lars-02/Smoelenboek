<nav x-data="{ open: false }">
    <div class="border-b-8 border-red-700 flex bg-white pr-32 px-6 py-3">
        <img href="{{ route('home') }}" class="select-none cursor-pointer h-10 mx-3 hidden sm:block" src="{{ asset("img/avans-log.png") }}" alt="Logo of Avans">
