<div class="mb-8">
    @if(isset($slot))
        <label class="text-xs sm:text-sm md:text-base lg:text-lg mb-1.5 pl-1.5 py-0.5 float-left text-left text-white w-6/12 bg-red-700 rounded font-medium" for="{{$id}}">{{$slot}}</label><br/>
    @endif
    <div>
